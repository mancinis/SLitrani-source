// @(#)root/html:$Id: TVisuSLit.h 2008-06-11
// Author: F.X. Gentit <http://gentit.home.cern.ch/gentit/>

/*************************************************************************
* Copyright (C) Those valid for CNRS software.                          *
*************************************************************************/
#ifndef ROOT_TVisuSLit
#define ROOT_TVisuSLit

//////////////////////////////////////////////////////////////////////////
//                                                                      //
// TVisuSLit                                                            //
//                                                                      //
// Visualize the ROOT files produced by SLitrani                        //
//                                                                      //
//////////////////////////////////////////////////////////////////////////
#include "TFile.h"
#include "TTree.h"
...
class TVisuSLit : public TGMainFrame {
...
protected:
  ...
  //File
  Bool_t               fFileClosed;      //True if SLitrani file has been closed
  TString              fFileName;        //Name of file to open
  TFile               *fLitFile;         //SLitrani file to be read
  ...
  void      OpenFileR();
  void      PrepareMenus();
  TLitResults *SelectRun();

public:

  TVisuSLit()                           { InitP();           }
  TVisuSLit(const TGWindow *p,UInt_t w, UInt_t h);
  virtual    ~TVisuSLit();
  void        ChangePadLogX();
  void        ChangePadLogY();
  void        DoDraw();
  ...
  void        ToggleColor();
  void        ToggleState();
  ClassDef(TVisuSLit,0)  //Visualize the ROOT files produced by SLitrani
};
R__EXTERN TVisuSLit *gVisuSlit;
#endif
