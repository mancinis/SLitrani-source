...
//
{
  ...
  delete fit;
  //
  k = gROOT->LoadMacro("AbsorptionLength_Aerogel.C",&error,kFALSE);
  if (k) gApplication->Terminate();
  fit = AbsorptionLength_Aerogel(kFALSE,kTRUE,kFALSE);
  nbfit++;
  cout << nbfit << "   AbsorptionLength_Aerogel" << " in SplineFitDB.rdb" << endl;
  delete fit;
  //
  ...
  delete fit;
  //
  k = gROOT->LoadMacro("DiffusionLength_Aerogel.C",&error,kFALSE);
  if (k) gApplication->Terminate();
  fit = DiffusionLength_Aerogel(kFALSE,kTRUE,kFALSE);
  nbfit++;
  cout << nbfit << "   DiffusionLength_Aerogel" << " in SplineFitDB.rdb" << endl;
  delete fit;
  //
  k = gROOT->LoadMacro("QuantumEff_Hamamatsu.C",&error,kFALSE);
  if (k) gApplication->Terminate();
  fit = QuantumEff_Hamamatsu(kFALSE,kTRUE,kFALSE);
  nbfit++;
  cout << nbfit << "   QuantumEff_Hamamatsu" << " in SplineFitDB.rdb" << endl;
  delete fit;
  //
  ...
  delete fit;
  //
  k = gROOT->LoadMacro("DEdx_Aerogel.C",&error,kFALSE);
  if (k) gApplication->Terminate();
  fit = DEdx_Aerogel(kFALSE,kTRUE,kFALSE);
  nbfit++;
  cout << nbfit << "   DEdx_Aerogel" << " in SplineFitDB.rdb" << endl;
  delete fit;
  //
  ...
  delete fit;
  //
  k = gROOT->LoadMacro("PhotoEl_Air.C",&error,kFALSE);
  if (k) gApplication->Terminate();
  fit = PhotoEl_Air(kFALSE,kTRUE,kFALSE);
  nbfit++;
  cout << nbfit << "   PhotoEl_Air" << " in SplineFitDB.rdb" << endl;
  delete fit;
  //
