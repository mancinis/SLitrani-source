{
  char *name    = "SLitFibre05";
  char *listing = "SLitFibre05";
  char *upcom   = "Setup with fibre, crystal and APD";
  char *downcom = "Simple example with thin slice and negative birefringence";
  ...
  //
  //  This example is identical with SLitFibre04, except that PbWO4 is now correctly handled
  // as negative birefringent.
  //
  ...
  */
  ...
  //____________________________________________________________________________
  //
  TGeoManager *geom = new TGeoManager("setup","SLitFibre05 of new Litrani");
  //____________________________________________________________________________
  //
  // Materials and media
  //____________________________________________________________________________
