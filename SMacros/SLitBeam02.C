{
  char *name    = "SLitBeam02";
  char *listing = "SLitBeam02";
  char *upcom   = "Beam of muons, crystal and APD with thin slice";
  char *downcom = "Beam issued from an ellipse, PbWO4 negativ birefringent";
  ...
  //
  //  This example is identical with SLitBeam01, except that:
  //   (1) - there is a thin slice at the entrance of the APD
  //   (2) - PbWO4 is correctly treated as negativ birefringent, not isotropic
  // 
  ...
  */
  ...
  //____________________________________________________________________________
  //
  TGeoManager *geom = new TGeoManager("setup","SLitBeam02 of new Litrani");
  //____________________________________________________________________________
  //
  // Materials and media
  //____________________________________________________________________________
  ...
  //  PbWO4 is correctly treated as negative birefringent by the call to IsUniAxialNegBirefr(). 
  //
  ...
  // [negative birefringent]. See the class description of TLitVolume. We use the constructor
