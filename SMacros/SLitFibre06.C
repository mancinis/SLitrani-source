{
  char *name    = "SlitFibre06";
  char *listing = "SlitFibre06";
  char *upcom   = "Setup with fibre, crystal and APD";
  char *downcom = "Simple example with thin slice and total anisotropy";
  ...
  //
  //  This example is identical with SLitFibre05, except that PbWO4 is treated as totally anisotropic
  // instead of negative birefringent, just in order to test Slitrani in a case of total anisotropy.
  // In real world PbWO4 is not totally anisotropic, but negative birefringent.
  //
  ...
  */
  ...
  //____________________________________________________________________________
  //
  TGeoManager *geom = new TGeoManager("setup","SlitFibre06 of new Litrani");
  //____________________________________________________________________________
  //
  // Materials and media
  //____________________________________________________________________________
  ...
  // See the class description of TLitVolume. We use the constructor of TLitVolume which at the
  // same time defines the 3 optical axis. The 3 optical axis fAniOx, fAniOy, fAniOz are the 3
  // axis of the coordinate system in which the dielectric tensor is diagonal, with eigenvalues
  //
